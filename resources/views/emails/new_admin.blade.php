                                ...
                                <tr>
                                    <td style="padding: 45px; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -1px rgba(0, 0, 0, 0.06);">
                                        <div style="font-size: 16px;">
                                            <h1 style="font-weight: 700; font-size: 24px; margin-top: 0; text-align: left;">!Bienvenido, {{$newAdmin->name}}!</h1>
                                            <p style="font-size: 16px; line-height: 24px; margin-top: 6px; margin-bottom: 20px;">
                                                Has sido agregado como Administrador en la plataforma de TX8.
                                                        ...
                                                        <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                                            <tr>
                                                                <td align="center" style="font-size: 16px;">
                                                                    <a href="https://tx8.com/login" target="_blank" style="display: inline-block; text-align: center; color: #ffffff; text-decoration: none; background-color: #d7bb7c; border-color: #d7bb7c; border-style: solid; border-width: 10px 18px; border-radius: 3px; font-weight: 500;">Iniciar Sesión</a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td style="background-color: #f4f4f5; border-radius: 2px; padding: 16px;">
                                                        <table style="width: 100%;" cellpadding="0" cellspacing="0" role="presentation">
                                                            ...
                                                            <tr>
                                                                <td style="font-family: Menlo, Consolas, monospace; font-size: 16px;">
                                                                    <strong>clave temporal:</strong> {{ $newAdmin->temp_pass }}
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
